...
{ 
    public class ZonesPanelManager : MonoBehaviour
    {
        ...
        [Header("General Script References")] [SerializeField]
        private CardZoneNumber cardZoneNumberPrefab;

        [SerializeField] private ScrollRect scrollRect;
        [SerializeField] private TextMeshProUGUI superZoneNumberText, safeZoneNumberText;
        ...
        [Header("CardZone State Management")] public CardZoneNumber previousCardZoneNumber;
        ...
        private void Initialize()
        {
            ...
            superZoneNumberText.text = _goldZoneIndex.ToString();
            safeZoneNumberText.text = _silverZoneIndex.ToString();
        }
        ...
        private void AnimateContentXPosition(Vector2 targetPosition)
        {
            ...
            {
                CollectedItemsPanelsManager.Instance.OnWheelSpinning.Invoke(
                    GameManager.Instance.wheelOfFortune.Spinning);
                ...
                GameManager.Instance.wheelOfFortune.TriggerAnimation("MakeBigger");
                GameManager.Instance.wheelOfFortune.SetButtonInteractable(!GameManager.Instance.wheelOfFortune
                    .Spinning);
            });
        }
        ...
        {
            if (_spinPanelManager.CurrentZoneIndex % GameManager.Instance.spinSettings.spinZonesIndex.SilverZoneIndex ==
                0 && scrollRect.content.transform.childCount < maxZoneNumber)
            {
        ...
        private void CheckZonesKindsPanelTexts()
        {
            ...
            {
                superZoneNumberText.text = (currentCardZoneNumber.ZoneNumber + _goldZoneIndex).ToString();
                return;
            }

            if (currentCardZoneNumber.ZoneNumber % _silverZoneIndex is not 0) return;
            safeZoneNumberText.text = (currentCardZoneNumber.ZoneNumber + _silverZoneIndex).ToString();
        }
    }
}